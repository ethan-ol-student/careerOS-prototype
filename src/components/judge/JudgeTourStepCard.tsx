...
const STATUS_CLASS: Record<JudgeTourStatus, string> = {
  Functional: "border-clover/40 bg-clover/10 text-clover",
  Prototype: "border-luminous/40 bg-luminous/10 text-luminous",
...
export function JudgeTourStepCard() {
  ...
  return (
    <section
      aria-live="polite"
      className="fixed bottom-4 left-4 right-4 z-[70] mx-auto max-w-xl rounded-2xl border border-border/40 bg-background/95 p-4 shadow-2xl backdrop-blur sm:bottom-6 sm:left-auto sm:right-6 sm:mx-0 sm:p-5"
    >
