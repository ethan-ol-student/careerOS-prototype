...
const STAGES = [
  "Reading your stage and goals…",
  "Mapping your field signals…",
  "Aligning your target trajectory…",
  "Compiling your living profile…",
];

/**
 * Full-screen loading interstitial shown between TargetJobStep and
 * CompleteStep. Simulates the platform analysing the candidate's
 * onboarding data. After totalDurationMs it calls onDone().
 */
  ...
  return (
    <div className="bg-background text-foreground relative flex min-h-screen flex-col">
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-12">
        <div className="glass-4 ring-luminous/20 relative w-full max-w-md overflow-hidden rounded-2xl p-8 text-center ring-1">
          <div
            aria-hidden
            className="from-luminous/25 pointer-events-none absolute -inset-12 rounded-full bg-radial to-transparent blur-2xl"
          />
          <div className="relative flex flex-col items-center gap-6">
            <div className="relative">
              <div className="bg-luminous/15 ring-luminous/40 flex size-20 items-center justify-center rounded-full ring-2">
                <Loader2 className="text-luminous size-10 animate-spin" />
              </div>
              <span
                aria-hidden
                className="bg-luminous/30 absolute inset-0 -z-10 animate-ping rounded-full"
              />
            </div>
            ...
            <div>
              ...
              <h2 className="mt-2 text-2xl font-semibold tracking-tight">
                Compiling your career intelligence
              </h2>
              <p
                key={stageIdx}
                ...
                return (
                  ...
                  >
                    {done ? (
                      ...
                      <Loader2 className="text-luminous size-3.5 animate-spin" />
                    ) : (
                      <span className="border-border/60 size-3.5 rounded-full border" />
                    )}
                    <span
                      className={
                        done
