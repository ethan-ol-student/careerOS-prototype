  ...
  return (
    <main className="bg-background text-foreground relative flex min-h-screen w-full items-center justify-center px-4">
      <div className="glass-3 ring-border/60 mx-auto flex w-full max-w-xl flex-col items-center gap-5 rounded-2xl p-8 text-center ring-1 sm:p-10">
        <span className="bg-luminous/15 text-luminous flex size-12 items-center justify-center rounded-2xl">
        ...
        <div className="mt-2 flex flex-col items-stretch gap-2 sm:flex-row sm:items-center">
          ...
          <Link
            ...
            className="text-muted-foreground hover:text-foreground focus-visible:ring-luminous/40 inline-flex min-h-10 items-center justify-center gap-2 rounded-md px-3 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2"
          >
